...
public class TextSelectionCursorController implements ViewTreeObserver.OnTouchModeChangeListener {
    ...
    public final boolean hide() {
        ...
        if (300 > System.currentTimeMillis() - this.mShowStartTime) {
            return false;
        }
        mStartHandle.hide();
        mEndHandle.hide();
    ...
    private void setInitialTextSelectionPosition(MotionEvent event) {
        ...
        if (!" ".equals(screen.getSelectedText(mSelX1, mSelY1, mSelX1, mSelY1))) {
            ...
            while (0 < this.mSelX1 && !screen.getSelectedText(mSelX1 - 1, mSelY1, mSelX1 - 1, mSelY1).isEmpty()) {
                mSelX1--;
            }
    ...
    private void setActionModeCallBacks() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                menu.add(Menu.NONE, ACTION_PASTE, Menu.NONE, "Paste").setEnabled(null != clipboard && clipboard.hasPrimaryClip());

...
public final class WcWidth {
    ...
    private static final int[][] ZERO_WIDTH = {{0x00300, 0x0036f},  // Combining Grave Accent  ..Combining Latin Small Le
...
// from https://github.com/jquast/wcwidth/pull/64
// at commit 1b9b6585b0080ea5cb88dc9815796505724793fe (2022-12-16):
    private static final int[][] WIDE_EASTASIAN = {{0x01100, 0x0115f},  // Hangul Choseong Kiyeok  ..Hangul Choseong Filler
    ...
    public static int width(int ucs) {
        if (ucs == 0x034F || (0x200B <= ucs && ucs <= 0x200F) || ucs == 0x2028 || ucs == 0x2029 || (0x202A <= ucs && ucs <= 0x202E) || (0x2060 <= ucs && ucs <= 0x2063) || ucs < 32 || (0x07F <= ucs && ucs < 0x0A0))
            return 0;

...
public class SharedProperties {
     ...
     */
    public static Object getDefaultIfNotInMap(@NonNull BiMap<?, ?> map, Object inputValue, Object defaultOutputValue) {
     ...
     */
    public static int getDefaultIfNotInRange(int value, int def, int min, int max, boolean ignoreErrorIfValueZero) {
     ...
     * @return Returns the {@code value} as is if within range. Otherwise returns default value.
     */
    public static float getDefaultIfNotInRange(float value, float def, float min, float max, boolean ignoreErrorIfValueZero) {
        if (value < min || value > max) {

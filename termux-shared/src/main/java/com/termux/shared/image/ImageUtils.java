...
public final class ImageUtils {
    ...
    /**
     * Wrapper for {@link #compressAndSaveBitmap(Bitmap, CompressFormat, int, String)} with `{@link CompressFormat#JPEG}` `format`.
     */
     ...
     *               depending on the {@link CompressFormat}.
     ...
     * otherwise {@code null}.
     */
    public static Error compressAndSaveBitmap(Bitmap bitmap, CompressFormat foramt, int quality, String path) {
     ...
     * otherwise {@code null}.
     */
    public static Error saveForDisplayResolution(Bitmap bitmap, Point point, String path2) {
        Error error;
         Bitmap bitmap2 = resizeBitmap(bitmap, point);

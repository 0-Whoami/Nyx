...
public class NotificationUtils {
     ...
     *  notificationBigText The full text of the notification that may optionally be styled.
     ...
     */
    @Nullable
    public static NotificationCompat.Builder geNotificationBuilder(final Context context, final String channelId, final int priority, final CharSequence title, final CharSequence notificationText,  final PendingIntent contentIntent, final PendingIntent deleteIntent, final int notificationMode) {
        if (context == null)
            return null;

...
public enum KeyHandler {
    ...
    static {
        ...
        // Shifted home
        KeyHandler.TERMCAP_TO_KEYCODE.put("#2", KeyHandler.KEYMOD_SHIFT | KeyEvent.KEYCODE_MOVE_HOME);
        KeyHandler.TERMCAP_TO_KEYCODE.put("#4", KeyHandler.KEYMOD_SHIFT | KeyEvent.KEYCODE_DPAD_LEFT);
        // Shifted end key
        KeyHandler.TERMCAP_TO_KEYCODE.put("*7", KeyHandler.KEYMOD_SHIFT | KeyEvent.KEYCODE_MOVE_END);
        ...
        // backspace key
        KeyHandler.TERMCAP_TO_KEYCODE.put("kb", KeyEvent.KEYCODE_DEL);
        // terminfo=kcud1, down-arrow key
        KeyHandler.TERMCAP_TO_KEYCODE.put("kd", KeyEvent.KEYCODE_DPAD_DOWN);
        ...
        KeyHandler.TERMCAP_TO_KEYCODE.put("kB", KeyHandler.KEYMOD_SHIFT | KeyEvent.KEYCODE_TAB);
        // terminfo=kdch1, delete-character key
        KeyHandler.TERMCAP_TO_KEYCODE.put("kD", KeyEvent.KEYCODE_FORWARD_DEL);
        // non-standard shifted arrow down
        KeyHandler.TERMCAP_TO_KEYCODE.put("kDN", KeyHandler.KEYMOD_SHIFT | KeyEvent.KEYCODE_DPAD_DOWN);
        // terminfo=kind, scroll-forward key
        KeyHandler.TERMCAP_TO_KEYCODE.put("kF", KeyHandler.KEYMOD_SHIFT | KeyEvent.KEYCODE_DPAD_DOWN);
        ...
        KeyHandler.TERMCAP_TO_KEYCODE.put("kR", KeyHandler.KEYMOD_SHIFT | KeyEvent.KEYCODE_DPAD_UP);
        // non-standard shifted up
        KeyHandler.TERMCAP_TO_KEYCODE.put("kUP", KeyHandler.KEYMOD_SHIFT | KeyEvent.KEYCODE_DPAD_UP);
